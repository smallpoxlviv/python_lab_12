...
class DwellingShema(ma.Schema):
    class Meta:
        fields = ('area_in_square_meters', 'price_in_USD', 'district', 'balcony_count')
...
def add_dwelling():
    new_dwelling = RestDwelling(request.json['area_in_square_meters'], request.json['price_in_USD'], request.json['district'], request.json['balcony_count'])
